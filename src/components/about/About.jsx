  ...
  return (
    <div id="about">
      <AboutWrapper>
        ...
        <AboutContainer>
          <h1>
            Czemu warto wybrać <span>PhotoPassion?</span>
          </h1>
          <p data-aos="fade-up">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi,
            voluptas eligendi. Suscipit sit nihil non harum minima aspernatur
            natus aliquid quam accusamus neque voluptatem soluta eaque,
            blanditiis quo magni rerum.
          </p>
          <p data-aos="fade-up">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quibusdam
            distinctio voluptatem voluptatum repellat praesentium nulla eum
            possimus vel atque sunt officiis maxime minus ducimus itaque, optio
            accusantium quae ut error. Laboriosam recusandae consectetur
            nesciunt sequi vel sapiente ex dicta ducimus inventore obcaecati.
            Temporibus praesentium facilis est labore adipisci eaque quibusdam
            quia voluptatem alias. Corrupti, repellendus exercitationem delectus
            alias labore veniam.
          </p>
          <p data-aos="fade-up">
